...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Gwangcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"gwangcoin.org", "dnsseed-gwangjin.actus.kr"},
    //{"gwangcoin.org", "dnsseed2.gwangcoin.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"gwangcoin.org", "test-dnsseed-gwangjin.actus.kr"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Gwangcoin is probably already running."), addrBind.ToString().c_str());
        else
