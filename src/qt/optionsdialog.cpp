...
void OptionsDialog::setMapper()
{
    ...
    /* Cashback */
    mapper->addMapping(ui->cashback,OptionsModel::Cashback);
    mapper->addMapping(ui->cashbackPercent,OptionsModel::CashbackPercent);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Gwangcoin."), QMessageBox::Ok);
